package fr.silenthill99.madeinabyss.custom.entities.models;// Made with Blockbench 4.9.4
...
public class HumanEntityModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Main.MODID, "humanentitymodel"), "main");
